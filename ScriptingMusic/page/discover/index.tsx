        ...
        <Section
          header={
            <HStack spacing={6} padding={{ top: 2, bottom: 2 }}>
              <Image systemName="music.note" font="subheadline" foregroundStyle="systemPink" />
              <Text font="title3" fontWeight="bold" foregroundStyle="label">LX Music 推荐</Text>
              <Spacer />
              <Text font="caption" foregroundStyle="tertiaryLabel">基于你的口味 · LX Music</Text>
            ...
            <HStack spacing={14} padding={16}>
              {recommend.map(t => (
                <RecommendCard
                  key={t.id}
                  track={t}
                  isPlaying={playerState.currentMusic?.id === t.id && (playerState.state === "playing" || playerState.state === "loading")}
          ...
          header={
            <HStack spacing={6} padding={{ top: 4, bottom: 2 }}>
              ...
              <HStack spacing={3}>
                ...
                <Text font="caption" foregroundStyle="tertiaryLabel">美区 · 30s 试听 · 完整播放走 LX Music</Text>
              </HStack>
            </HStack>
          }
        >
    ...
    >
      ...
      <VStack alignment="leading" spacing={3}>
        ...
        <HStack spacing={4}>
          ...
          <Text font="caption2" foregroundStyle={sourceColor("lxmusic") as any} fontWeight="medium">{sourceLabel("lxmusic")}</Text>
        </HStack>
      </VStack>

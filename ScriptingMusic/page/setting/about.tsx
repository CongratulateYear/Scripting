...
const SERVICES: ServiceItem[] = [
  {
    name: "LX Music (ikunshare)",
    usage: "音乐搜索与音频解析（优先源，支持 KuGou / NetEase / QQ Music / MiGu 等多平台）",
    url: "https://github.com/tfappstore/lx-music-source",
  },
  {
    name: "MP3Juice",
    usage: "音乐搜索与音频下载（回退源，YouTube 生态）",

...
**[👉 点击安装 Scripting Music](https://scripting.fun/import_scripts?urls=%5B%22https%3A%2F%2Fgithub.com%2FCongratulateYear%2FScripting%2Ftree%2Fmain%2FScriptingMusic%22%5D)**
...
| 类型 | 路径 |
|------|------|
| JSON 数据库 | `<Scripting Music>/music_store.json` |
| 音频文件 | `<Scripting Music>/audios/<id>.mp3` |
| 封面图片 | `<Scripting Music>/covers/<id>.jpg` |
| 歌词文件 | `<Scripting Music>/lyrics/<id>.json` |
